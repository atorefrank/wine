...
def add_review(request, wine_id):
    ...
    if form.is_valid():
        coffee_roast = form.cleaned_data['coffee_roast']
        chocolate_color = form.cleaned_data['chocolate_color']
        tart_creamy = form.cleaned_data['tart_creamy']
        fruit_pastry = form.cleaned_data['fruit_pastry']
        herbaceous = form.cleaned_data['herbaceous']
        comment = form.cleaned_data['comment']
        user_name = request.user.username
        review = Review()
        review.wine = wine
        review.user_name = user_name
        review.coffee_roast = coffee_roast
        review.chocolate_color = chocolate_color
        review.tart_creamy = tart_creamy
        review.fruit_pastry = fruit_pastry
        review.herbaceous = herbaceous
        review.setrating({'coffee_roast':coffee_roast, 'chocolate_color': chocolate_color, 'tart_creamy':tart_creamy, 'fruit_pastry':fruit_pastry, 'herbaceous':herbaceous})
